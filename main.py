...
if __name__ == '__main__':
    ...
    if args.gnn == 'lightgcn':
        if args.ns in ["rns", "dns","mixgcf", "dins"]:
            from modules.LightGCN import LightGCN
        elif args.ns in ["dens"]:
            from modules.LightGCN_DENS import LightGCN
        elif args.ns in ["ahns"]:
            from modules.LightGCN_AHNS import LightGCN        
        elif args.ns in ["dcans"]:
            from modules.LightGCN_DCANS import LightGCN
        else:
